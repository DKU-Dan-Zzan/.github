...
| 박주희 | 32221902 | Kafka 기반 비동기 티켓 발급 파이프라인 및 대기열 시스템 구현, 팔찌 배부 현황 실시간 조회 및 관리 플랫폼 개발, QR 코드 기반 입장 검증, 회원 탈퇴·비밀번호 재설정 개발 |
| 박지우 | 32211862 | Spring Security 기반 JWT 회원 인증 체계 설계, 단국대 포털 크롤링 학번 인증·로그인·회원가입 구현, Redis 대기열 및 Lua Script 원자적 선착순 처리로 티켓 예매 시스템 개발 |
